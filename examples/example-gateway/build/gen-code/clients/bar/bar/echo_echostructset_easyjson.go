...
// @generated
// Checksum : LieTt5xtdN8emS8LCs1MdA==
...
func easyjsonF2b6890eDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBarEchoEchoStructSet(in *jlexer.Lexer, out *Echo_EchoStructSet_Result) {
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjsonF2b6890eDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(in, &*v1)
					}
...
func easyjsonF2b6890eEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBarEchoEchoStructSet(out *jwriter.Writer, in Echo_EchoStructSet_Result) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Success) != 0 {
		...
		if in.Success == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v2, v3 := range in.Success {
				...
				if v3 == nil {
					...
					easyjsonF2b6890eEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(out, *v3)
				}
			}
			out.RawByte(']')
		}
...
func (v Echo_EchoStructSet_Result) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonF2b6890eEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBarEchoEchoStructSet(&w, v)
...
func (v *Echo_EchoStructSet_Result) UnmarshalJSON(data []byte) error {
	...
	easyjsonF2b6890eDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBarEchoEchoStructSet(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Echo_EchoStructSet_Result) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonF2b6890eDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBarEchoEchoStructSet(l, v)
}
func easyjsonF2b6890eDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(in *jlexer.Lexer, out *BarResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonF2b6890eEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(out *jwriter.Writer, in BarResponse) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
...
func easyjsonF2b6890eDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBarEchoEchoStructSet1(in *jlexer.Lexer, out *Echo_EchoStructSet_Args) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjsonF2b6890eDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(in, &*v11)
					}
...
func easyjsonF2b6890eEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBarEchoEchoStructSet1(out *jwriter.Writer, in Echo_EchoStructSet_Args) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
	...
	if in.Arg == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
		...
		for v12, v13 := range in.Arg {
			...
			if v13 == nil {
				...
				easyjsonF2b6890eEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(out, *v13)
			}
		}
		out.RawByte(']')
	}
...
func (v Echo_EchoStructSet_Args) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonF2b6890eEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBarEchoEchoStructSet1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *Echo_EchoStructSet_Args) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonF2b6890eDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBarEchoEchoStructSet1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Echo_EchoStructSet_Args) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonF2b6890eDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBarEchoEchoStructSet1(l, v)
}
